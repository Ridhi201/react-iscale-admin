...
async function test() {
  try {
    ...
    const loginRes = await axios.post('https://iscale-backend.onrender.com/myadmin/admin-login', {
    ...
    const res = await axios.get('https://iscale-backend.onrender.com/myadmin/comp-requirement/get-all-jobs', {
