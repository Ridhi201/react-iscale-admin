...
import { allNotesWishlistData } from '../../utils/mockData'

const TOTAL_ENTRIES = allNotesWishlistData.length
...
export default function NotesWishlist() {
  ...
  const currentData = allNotesWishlistData.slice(startIndex, endIndex)
  ...
  return (
    <div className="h-full animate-fade-in-up">
      {/* Title Card */}
        ...
        <h2 className="text-indigo-900 dark:text-indigo-300 font-bold tracking-tight text-xl font-medium">Notes Wishlist List</h2>
      </div>
