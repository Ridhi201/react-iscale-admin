...
import { allNotesRegistrationData } from '../../utils/mockData'

const TOTAL_ENTRIES = allNotesRegistrationData.length

export default function NotesRegistrations() {
  ...
  const currentData = allNotesRegistrationData.slice(startIndex, endIndex)
  ...
  return (
    <div className="h-full animate-fade-in-up">
      {/* Title Card */}
        ...
        <h2 className="text-indigo-900 dark:text-indigo-300 font-bold tracking-tight text-xl font-medium">Purchased Notes List</h2>
      </div>
      ...
      {/* Filters Card */}
        ...
        <div className="flex flex-wrap items-end gap-5 w-full">
          ...
          {/* Notes */}
          <div className="flex-1 min-w-[200px]">
            <label className="block text-sm font-bold text-slate-800 dark:text-slate-200 mb-2">Notes</label>
          ...
          <table className="w-full text-left text-sm text-slate-800 dark:text-slate-200">
            <thead className="bg-slate-50 dark:bg-[#13111c] text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-gray-800">
              <tr>
                ...
                <th className="px-3 py-3 font-semibold text-xs border-r border-slate-200 dark:border-gray-800/50 align-top">Note Title</th>
              ...
              {currentData.map((row) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                    <div className="w-24 break-words">{row.student}</div>
                  </td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.noteTitle}</td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
