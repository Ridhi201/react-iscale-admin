...
import { allCourseWishlistData } from '../../utils/mockData'

const TOTAL_ENTRIES = allCourseWishlistData.length
...
export default function CourseWishlist() {
  ...
  const currentData = allCourseWishlistData.slice(startIndex, endIndex)
  ...
  return (
    <div className="h-full animate-fade-in-up">
      {/* Title Card */}
        ...
        <h2 className="text-indigo-900 dark:text-indigo-300 font-bold tracking-tight text-xl font-medium">Course Wishlist List</h2>
      </div>
            ...
            <tbody>
              {currentData.map((row) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.contact}</td>
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50 text-slate-600 dark:text-slate-400">
                    <div className="w-32">{row.course}</div>
                  </td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
