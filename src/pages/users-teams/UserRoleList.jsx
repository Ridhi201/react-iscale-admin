    ...
    <div className="h-full animate-fade-in-up">
      <div className="bg-[#f6f6ff] rounded-2xl shadow-md hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] transition-shadow border border-slate-100 transition-colors overflow-hidden flex flex-col h-full">
        <div className="p-4 border-b border-slate-200 dark:border-gray-800/50 flex justify-between items-center bg-[#f6f6ff] dark:bg-[#1f1b2e]">
          <h2 className="text-xl font-medium text-indigo-900 dark:text-indigo-300 font-bold tracking-tight">All Users List</h2>
          <button 
            onClick={() => navigate('/user-role/add')}
            ...
            <table className="w-full text-left text-sm text-slate-800 dark:text-slate-200">
              <thead className="bg-slate-50 dark:bg-[#13111c] text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-gray-800">
                <tr>
                  ...
                  <th className="px-4 py-3 font-bold border-r border-slate-200 dark:border-gray-800/50 whitespace-nowrap">Permission</th>
                  <th className="px-4 py-3 font-bold border-r border-slate-200 dark:border-gray-800/50 whitespace-nowrap">Login ID</th>
                ...
                {currentEntries.map((row) => (
                  <tr key={row.id} className={`border-b border-slate-200 dark:border-gray-800/50 hover:bg-slate-50 dark:bg-[#1f1b2e]/50 ${row.sno === 2 ? 'bg-[#fdf2e9]' : 'bg-[#f6f6ff] dark:bg-[#111827] hover:bg-slate-50 dark:bg-[#1f1b2e]/50 dark:hover:bg-[#1f2937] transition-colors'}`}>
                    ...
                    <td className="px-4 py-4 border-r border-slate-200 dark:border-gray-800/50 align-middle whitespace-nowrap">
                      <button className="bg-[#00a65a] text-white px-3 py-1.5 rounded-full text-sm font-medium hover:bg-[#008d4c] transition-colors shadow-sm">
                        Permission
                      </button>
                    </td>
                    <td className="px-4 py-4 border-r border-slate-200 dark:border-gray-800/50 align-middle whitespace-nowrap">{row.loginId}</td>
                    <td className="px-4 py-4 border-r border-slate-200 dark:border-gray-800/50 align-middle whitespace-nowrap">{row.contact}</td>
                    <td className="px-4 py-4 border-r border-slate-200 dark:border-gray-800/50 align-middle whitespace-nowrap">{row.email}</td>
                    <td className="px-4 py-4 border-r border-slate-200 dark:border-gray-800/50 align-middle whitespace-nowrap">{row.addedOn}</td>
                    <td className="px-4 py-4 border-r border-slate-200 dark:border-gray-800/50 align-middle text-center">
                      <button className="bg-[#428bca] text-white px-3 py-1.5 rounded-full text-xs font-medium hover:bg-[#3071a9] transition-colors shadow-sm">
                        {row.status}
                      </button>
                    </td>
                    <td className="px-4 py-4 align-middle">
                      <div className="flex gap-2">
                        <button className="bg-[#00a65a] text-white p-2 rounded-full hover:bg-[#008d4c] transition-colors inline-flex items-center justify-center shadow-sm">
                          <Edit2 size={14} />
                        </button>
                        <button className="bg-[#6366f1] text-white p-2 rounded-full hover:bg-[#d87025] transition-colors inline-flex items-center justify-center shadow-sm">
                          <Trash2 size={14} />
                        </button>
                      </div>
                    </td>
