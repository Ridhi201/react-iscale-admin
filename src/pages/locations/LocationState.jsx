...
export default function LocationState() {
  const mockData = [
    { id: 1, sno: 1, stateName: 'Andhra Pradesh', countryName: 'India' },
    { id: 2, sno: 2, stateName: 'Arunachal Pradesh', countryName: 'India' },
    { id: 3, sno: 3, stateName: 'Assam', countryName: 'India' },
    { id: 4, sno: 4, stateName: 'Bihar', countryName: 'India' },
    { id: 5, sno: 5, stateName: 'Chhattisgarh', countryName: 'India' },
    { id: 6, sno: 6, stateName: 'Goa', countryName: 'India' },
    { id: 7, sno: 7, stateName: 'Gujarat', countryName: 'India' },
    { id: 8, sno: 8, stateName: 'Haryana', countryName: 'India' }
  ]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
        ...
        <div className="lg:col-span-2 bg-[#f6f6ff] rounded-2xl shadow-md hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] transition-shadow border border-slate-100 transition-colors flex flex-col overflow-hidden">
          <div className="p-4 border-b border-slate-200 dark:border-gray-800/50">
            <h2 className="text-xl font-medium text-indigo-900 dark:text-indigo-300 font-bold tracking-tight">State List</h2>
          </div>
                ...
                <tbody>
                  {mockData.map((row) => (
                    <tr key={row.id} className="border-b border-slate-200 dark:border-gray-800/50 hover:bg-slate-50 dark:bg-[#1f1b2e]/50">
                      ...
                      <td className="px-4 py-3 border-r border-slate-200 dark:border-gray-800/50">{row.stateName}</td>
        ...
        <div className="lg:col-span-1 bg-[#f6f6ff] rounded-2xl shadow-md hover:shadow-[0_8px_30px_rgba(99,102,241,0.15)] transition-shadow border border-slate-100 transition-colors h-fit">
          <div className="p-6">
            <h2 className="text-xl font-medium text-center text-indigo-900 dark:text-indigo-300 font-bold tracking-tight mb-5 border-b border-slate-100 pb-4">Add New State</h2>
            <form className="flex flex-col gap-4">
              <SelectField label="Country" options={['- - Select - -', 'India']} />
              <InputField label="State Name" placeholder="Enter State Name" />
