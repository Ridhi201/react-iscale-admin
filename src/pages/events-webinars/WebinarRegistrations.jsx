...
import { allWebinarRegistrationData } from '../../utils/mockData'

const TOTAL_ENTRIES = allWebinarRegistrationData.length
...
export default function WebinarRegistrations() {
  ...
  const currentData = allWebinarRegistrationData.slice(startIndex, endIndex)
            ...
            <tbody>
              {currentData.map((row) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.webinar}</td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
