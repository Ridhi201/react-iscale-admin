...
import { allCourseRegistrationData } from '../../utils/mockData'

const ENTRIES_PER_PAGE = 50
const TOTAL_ENTRIES = allCourseRegistrationData.length
export default function Registrations() {
  ...
  const currentData = allCourseRegistrationData.slice(startIndex, endIndex)
  ...
  return (
    <div className="h-full animate-fade-in-up">
      {/* Title Card */}
        ...
        <h2 className="text-indigo-900 dark:text-indigo-300 font-bold tracking-tight text-xl font-medium">Purchased Courses List</h2>
      </div>
          ...
          <table className="w-full text-left text-sm text-slate-800 dark:text-slate-200">
            <thead className="bg-slate-50 dark:bg-[#13111c] text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-gray-800">
              <tr>
                ...
                <th className="px-3 py-3 font-semibold text-xs border-r border-slate-200 dark:border-gray-800/50 align-top">App Durration</th>
                <th className="px-3 py-3 font-semibold text-xs border-r border-slate-200 dark:border-gray-800/50 align-top">Web Durration</th>
                <th className="px-3 py-3 font-semibold text-xs align-top">Batch Name</th>
              </tr>
            </thead>
            <tbody>
              {currentData.map((row) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.phone}</td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                    <div className="max-w-[120px] break-words">{row.email}</div>
                  </td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                    <div className="max-w-[100px] break-words">{row.course}</div>
                  </td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                    <div className="max-w-[100px] break-words">{row.appDuration}</div>
                  </td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                    <div className="max-w-[100px] break-words">{row.webDuration}</div>
                  </td>
                  <td className="px-3 py-3 text-xs">{row.batchName}</td>
                </tr>
              ))}
            </tbody>
          </table>
