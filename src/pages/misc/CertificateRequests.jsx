...
import { allCertificateRequestData } from '../../utils/mockData'

const ENTRIES_PER_PAGE = 10
const TOTAL_ENTRIES = allCertificateRequestData.length
export default function CertificateRequests() {
  ...
  const currentData = allCertificateRequestData.slice(startIndex, endIndex)
  ...
  return (
    <div className="h-full animate-fade-in-up">
      {/* Title Card */}
        ...
        <h2 className="text-indigo-900 dark:text-indigo-300 font-bold tracking-tight text-xl font-medium">Course Request</h2>
      </div>
          ...
          <table className="w-full text-left text-sm text-slate-800 dark:text-slate-200">
            <thead className="bg-slate-50 dark:bg-[#13111c] text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-gray-800">
              <tr>
                ...
                <th className="px-3 py-3 font-semibold text-xs border-r border-slate-200 dark:border-gray-800/50 align-top">Certificate Number</th>
            ...
            <tbody>
              {currentData.map((row) => (
                ...
                >
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.course}</td>
                  ...
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.progress}</td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.certNumber}</td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">{row.certPdf}</td>
                  <td className="px-3 py-3 text-xs border-r border-slate-200 dark:border-gray-800/50">
                    <span className="bg-[#ffc107] text-indigo-900 dark:text-indigo-300 font-bold tracking-tight px-3 py-1 rounded-full text-xs font-bold">
                      {row.status}
                    </span>
                  </td>
                  <td className="px-3 py-3 text-xs">
                    <button className="bg-slate-50 dark:bg-[#13111c] text-slate-700 dark:text-slate-200 border-b border-slate-200 dark:border-gray-800 px-3 py-1.5 rounded-full text-xs font-medium whitespace-nowrap hover:bg-[#152a4a] transition-colors">
                      Change Status
                    </button>
                  </td>
                </tr>
