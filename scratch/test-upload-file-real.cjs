...
async function run() {
  ...
  form.append('certificate_no', 'CERT-REAL-FILE');
  
  // Create a buffer for a dummy PDF file
  ...
  try {
    ...
    console.log("Record details after file upload:", JSON.stringify(record, null, 2));
